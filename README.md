...
| Discussion Thread |
|-------------------|
| <br>[**Language-integrated Set Algebra in RDF Languages**](https://github.com/AdamSobieski/Web/discussions/8)<br>Using the `Link` HTTP response header, resources, in particular sets of individuals and sets of RDF statements, can provide links to their provenance data including any SPARQL queries used to obtain them. This, along with the HTTP `HEAD` method, can enable or simplify performing set-algebraic operations on potentially large sets without having to download and exhaustively iterate or enumerate them.<br><br> |
