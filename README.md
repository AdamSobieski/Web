...
| Discussion Thread |
|-------------------|
| <br>[**Sets, Provenance, and Queries**](https://github.com/AdamSobieski/Web/discussions/8)<br>Resources, in particular sets of individuals and sets of statements, can provide, via the HTTP `Link` response header, links to their provenance data including those SPARQL queries which were utilized to obtain them. This, along with the HTTP HEAD method, can enable or simplify performing set-algebraic operations on potentially large sets without having to download and exhaustively iterate or enumerate them.<br><br> |
