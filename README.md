...
| <br>[**Dereferencing URLs in RDF Languages**](https://github.com/AdamSobieski/Web/discussions/7)<br>Drawing inspiration from pointers in computer-programming languages like C and C++, proposed for RDF languages is that the `*` symbol could be used to dereference URLs into: IRIs, literals, triples, quads, graphs, and datasets.<br><br> |
| <br>[**Sets, Provenance, and Queries**](https://github.com/AdamSobieski/Web/discussions/8)<br>Resources, in particular sets of individuals and of statements, can provide, via the HTTP `Link` response header, links to their provenance data including those SPARQL queries which were utilized to obtain them. This can enable or simplify: (1) performing set-algebraic operations on potentially large sets without having to download them and exhaustively iterate or enumerate them, and (2) language-integrated querying in RDF languages.<br><br> |
