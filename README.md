...
| <br>[**Sets, Provenance, and Queries**](https://github.com/AdamSobieski/Web/discussions/8)<br>Resources, in particular sets of individuals and of statements, can provide, via the HTTP `Link` response header, links to their provenance data including those SPARQL queries which were utilized to obtain them. This can enable or simplify performing set-algebraic operations on potentially large sets without having to download them and exhaustively iterate or enumerate them.<br><br> |
